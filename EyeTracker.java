...
public class EyeTracker {
    ...
    void processEye(Mat eye, String title) throws Exception {
        ...
        Imgcodecs.imwrite("C:\\Users\\dhanesh\\Desktop\\projects\\eye tracking\\pic_op" + title + "" + EyeTracker.no + "_eye_bin.jpg", bin);
        ...
        Imgcodecs.imwrite("C:\\Users\\dhanesh\\Desktop\\projects\\eye tracking\\pic_op" + title + "" + EyeTracker.no + "_eye_norm.jpg", norm);
        Imgcodecs.imwrite("C:\\Users\\dhanesh\\Desktop\\projects\\eye tracking\\pic_op" + title + "" + EyeTracker.no + "_eye_binary.jpg", bin);
        Imgcodecs.imwrite("C:\\Users\\dhanesh\\Desktop\\projects\\eye tracking\\pic_op" + title + "" + EyeTracker.no + "_eye.jpg", eye);
    }
    ...
    public static void main(final String[] args) throws Exception {
        ...
        Mat frame;
        frame = Imgcodecs.imread("C:\\Users\\dhanesh\\Desktop\\projects\\eyetracker\\pic_ip" + EyeTracker.no + ".jpg");
    ...
    public static ArrayList<Integer> getCorneaCenterAndRadius(int row, int start_x, int end_x, Mat m) {
        ...
        Imgcodecs.imwrite("C:\\Users\\dhanesh\\Desktop\\projects\\eye tracking\\pic_op" + EyeTracker.no + "_eye_bin.jpg", m);
