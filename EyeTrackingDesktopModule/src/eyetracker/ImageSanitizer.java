...
public class ImageSanitizer {
    ...
    static ArrayList<MatAndPoint> detectEyes(Mat frame) {
        try{
            ...
            Point right = new Point(rect.x, rect.y);

            Rect R = new Rect(rect.x, rect.y, rect.width, rect.height); //Create a rect
            Mat ROI = new Mat(frame, R);

//            Imgcodecs.imwrite("C:\\Users\\om\\Desktop\\github_repos\\EyeTracking\\interim\\temp.jpg", ROI);
