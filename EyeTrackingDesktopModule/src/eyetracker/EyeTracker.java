...
public class EyeTracker {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        Mat frame;
        frame = Imgcodecs.imread("C:\\Users\\om\\Downloads\\temp.jpg");
...
//        Imgcodecs.imwrite("C:\\Users\\om\\Desktop\\github_repos\\EyeTracking\\interim\\pic_op" + title + "" + EyeTracker.no + "_eye.bmp", eye);
    ...
    public Mat getPrediction() {
        try {
            ...
            Imgproc.circle(colorful, p0, (int) left_center.radius, new Scalar(255, 0, 0));
            Imgproc.circle(colorful, p1, (int) right_center.radius, new Scalar(255, 0, 0));
