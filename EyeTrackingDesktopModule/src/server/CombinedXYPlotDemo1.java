...
//
//        Mat eye = frame.rowRange(rect.y + 1, rect.y + rect.height);
...
//        Imgcodecs.imwrite("C:\\Users\\dhanesh\\Desktop\\projects\\eyetracker\\pic_op" + CombinedXYPlotDemo1.no + "_eye_bin.jpg", bin);
//
...
//        iris_test.detectWhileCalibration(bin, eye);
//
//        for (int k = 0; k < 8; k++) {
//            norm.put(test.list.get(k).second.intValue(), test.list.get(k).first.intValue(), 0);
//        }
//
//        Imgcodecs.imwrite("C:\\Users\\dhanesh\\Desktop\\projects\\eyetracker\\pic_op" + CombinedXYPlotDemo1.no + "_eye_norm.jpg", norm);
//        Imgcodecs.imwrite("C:\\Users\\dhanesh\\Desktop\\projects\\eyetracker\\pic_op" + CombinedXYPlotDemo1.no + "_eye_binary.jpg", bin);
//        Imgcodecs.imwrite("C:\\Users\\dhanesh\\Desktop\\projects\\eyetracker\\pic_op" + CombinedXYPlotDemo1.no + "_eye.jpg", eye);
//    }
//
...
//        }
//        Imgcodecs.imwrite("C:\\Users\\dhanesh\\Desktop\\projects\\eyetracker\\pic_op" + CombinedXYPlotDemo1.no + "_eye_bin.jpg", m);
//
//        for (int i = 0; i < 2; i++) {
//
//            int temp_y = row;
