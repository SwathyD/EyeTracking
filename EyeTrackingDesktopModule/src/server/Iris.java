...
//    }
//
//    void detectWhileCalibration(Mat bin_eye, Mat eye) throws Exception {
...
//
//        Imgproc.circle(eye, new Point(c_x+max/2, index), max/2 + 1, new Scalar(255));
//    }
//
...
//            ArrayList<ArrayList<Integer>> list = CombinedXYPlotDemo1.getBlackList(y, image);
//
//            int i;
